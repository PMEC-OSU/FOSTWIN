...
This button only needs to be pressed once when you're about to sign out of the system.  This button essentially resets things on the host machine to be ready for a next user.  
